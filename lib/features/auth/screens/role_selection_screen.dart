              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildRoleOption(
                      title: 'Driver',
                      description: 'I drive buses and want to share my location with passengers',
                      icon: Icons.drive_eta_rounded,
                      iconColor: AppColors.primary,
                      onTap: authService.isLoading ? null : () => _selectRole('driver'),
                    ),
                    ...
                    _buildRoleOption(
                      title: 'Passenger',
                      description: 'I want to track buses and plan my journeys',
                      icon: Icons.person_rounded,
                      iconColor: AppColors.secondary,
                      onTap: authService.isLoading ? null : () => _selectRole('passenger'),
                    ),
