...
CREATE TABLE realtime.messages_2025_07_10 (
  ...
  inserted_at timestamp without time zone NOT NULL DEFAULT now(),
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  CONSTRAINT messages_2025_07_10_pkey PRIMARY KEY (inserted_at, id)
);
CREATE TABLE realtime.messages_2025_07_11 (
  ...
  inserted_at timestamp without time zone NOT NULL DEFAULT now(),
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  CONSTRAINT messages_2025_07_11_pkey PRIMARY KEY (inserted_at, id)
);
CREATE TABLE realtime.messages_2025_07_12 (
  ...
  inserted_at timestamp without time zone NOT NULL DEFAULT now(),
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  CONSTRAINT messages_2025_07_12_pkey PRIMARY KEY (inserted_at, id)
);
CREATE TABLE realtime.messages_2025_07_13 (
  ...
  inserted_at timestamp without time zone NOT NULL DEFAULT now(),
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  CONSTRAINT messages_2025_07_13_pkey PRIMARY KEY (inserted_at, id)
);
CREATE TABLE realtime.messages_2025_07_14 (
  ...
  inserted_at timestamp without time zone NOT NULL DEFAULT now(),
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  CONSTRAINT messages_2025_07_14_pkey PRIMARY KEY (inserted_at, id)
);
